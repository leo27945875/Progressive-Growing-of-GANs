...
if __name__ == '__main__':
    ...
    disLoss = DiscriminatorLoss(args.GAN_LOSS_PENALTY, args.DRIFT_PENALTY)
    ...
    if args.IS_LOAD_MODEL:
        checkpoint = LoadCheckPoint(loadSize, loadEpoch, args.MODEL_SAVE_FOLDER)
        gen   .load_state_dict(checkpoint["gen"   ])
        dis   .load_state_dict(checkpoint["dis"   ])
        genOpt.load_state_dict(checkpoint["genOpt"])
        disOpt.load_state_dict(checkpoint["disOpt"])
