...
def SaveCheckPoint(gen, dis, imgSize, epoch, folder):
    torch.save(gen, os.path.join(folder, f"GenModel_Size{imgSize}_Epoch{epoch}.pth" ))
    torch.save(dis, os.path.join(folder, f"DisModel_Size{imgSize}_Epoch{epoch}.pth" ))


def LoadCheckPoint(imgSize, epoch, folder):
    gen = torch.load(os.path.join(folder, f"GenModel_Size{imgSize}_Epoch{epoch}.pth" ))
    dis = torch.load(os.path.join(folder, f"DisModel_Size{imgSize}_Epoch{epoch}.pth" ))
    return gen, dis
